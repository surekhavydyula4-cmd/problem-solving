...
-- Difficulty: Easy
-- Topic: CASE + SUM + AVG + GROUP BY
-- Find each query_name, its quality score, and poor query percentage.
...
-- Difficulty: Easy
-- Topic: LEFT JOIN + NULL Filtering + GROUP BY + COUNT
...
-- Difficulty: Easy
-- Topic: SELF JOIN + GROUP BY + AVG + ROUND
...
-- Convert store columns into rows and exclude NULL prices.
